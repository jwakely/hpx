...
namespace hpx { namespace ranges {
    ...
    typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
        bool>::type
    ends_with(ExPolicy&& policy, Rng1&& rng1, Rng2&& rng2, Pred&& pred = Pred(),
        Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2());
...
namespace hpx::ranges {
    ...
    private:
        ...
        // clang-format on
        friend bool tag_fallback_invoke(hpx::ranges::ends_with_t, Iter1 first1,
            ...
            Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::ends_with().call(hpx::execution::seq,
                first1, last1, first2, last2, HPX_FORWARD(Pred, pred),
        ...
        friend typename parallel::util::detail::algorithm_result<ExPolicy,
            bool>::type
        tag_fallback_invoke(hpx::ranges::ends_with_t, ExPolicy&& policy,
        ...
        // clang-format on
        friend bool tag_fallback_invoke(hpx::ranges::ends_with_t, Rng1&& rng1,
            ...
            Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::ends_with().call(
                ...
                hpx::util::end(rng2), HPX_FORWARD(Pred, pred),
                HPX_FORWARD(Proj1, proj1), HPX_FORWARD(Proj2, proj2));
        }
    } ends_with{};
