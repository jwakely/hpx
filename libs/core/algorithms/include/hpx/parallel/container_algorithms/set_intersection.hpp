...
namespace hpx { namespace ranges {
    ...
    ///
    /// \returns  The \a set_intersection algorithm returns \a
    ///           ranges::set_intersection_result<Iter1, Iter2, Iter3>.
    ///           The \a set_intersection algorithm returns the output iterator to the
    ///           element in the destination range, one past the last element
    ///           copied.
    ///
    template <typename Iter1, typename Sent1, typename Iter2, typename Sent2,
        ...
        typename Proj1 = hpx::identity,
        typename Proj2 = hpx::identity>
    set_intersection_result<Iter1, Iter2, Iter3> set_intersection(Iter1 first1,
        Sent1 last1, Iter2 first2, Sent2 last2, Iter3 dest, Pred&& op = Pred(),
        Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2());
    ...
    set_intersection(Rng1&& rng1, Rng2&& rng2, Iter3 dest,
        Pred&& op = Pred(), Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2());
...
namespace hpx::ranges {
    ...
    private:
        ...
        friend typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
            set_intersection_result<Iter1, Iter2, Iter3>>::type
        tag_fallback_invoke(set_intersection_t, ExPolicy&& policy, Iter1 first1,
            ...
            Proj2&& proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::set_intersection<result_type>().call2(
                HPX_FORWARD(ExPolicy, policy), is_seq(), first1, last1, first2,
                last2, dest, HPX_FORWARD(Pred, op), HPX_FORWARD(Proj1, proj1),
        ...
        friend typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
            set_intersection_result<
                typename hpx::traits::range_iterator<Rng1>::type,
                typename hpx::traits::range_iterator<Rng2>::type, Iter3>>::type
        tag_fallback_invoke(set_intersection_t, ExPolicy&& policy, Rng1&& rng1,
            ...
            Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2())
        {
            ...
            static_assert(
                hpx::traits::is_forward_iterator_v<iterator_type1>,
                "Requires at least forward iterator.");
            static_assert(
            ...
            return hpx::parallel::detail::set_intersection<result_type>().call2(
                HPX_FORWARD(ExPolicy, policy), is_seq(), hpx::util::begin(rng1),
            ...
            Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::set_intersection<result_type>().call(
        ...
        friend set_intersection_result<
            typename hpx::traits::range_iterator<Rng1>::type,
            typename hpx::traits::range_iterator<Rng2>::type, Iter3>
        tag_fallback_invoke(set_intersection_t, Rng1&& rng1, Rng2&& rng2,
            ...
            Proj2&& proj2 = Proj2())
        {
            ...
            static_assert(
                hpx::traits::is_input_iterator_v<iterator_type1>,
                "Requires at least input iterator.");
            static_assert(
                hpx::traits::is_input_iterator_v<iterator_type2>,
                "Requires at least input iterator.");
            static_assert(hpx::traits::is_output_iterator_v<Iter3>,
