...
namespace hpx {
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, RandIter3>
...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        struct merge final : public algorithm<merge<IterTuple>, IterTuple>
        {
    ...
    namespace detail {
        ...
        struct inplace_merge final
          : public algorithm<inplace_merge<Result>, Result>
        {
...
namespace hpx {
    ...
    private:
        ...
        // clang-format on
        friend hpx::parallel::util::detail::algorithm_result_t<
            ExPolicy>
