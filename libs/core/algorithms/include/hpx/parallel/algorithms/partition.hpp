...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        struct stable_partition final
          : public algorithm<stable_partition<Iter>, Iter>
        {
...
#pragma GCC diagnostic pop
    ...
    namespace detail {
        ...
        template <typename FwdIter>
        struct partition final : public algorithm<partition<FwdIter>, FwdIter>
        {
