...
namespace hpx {
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, void> reverse(
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, FwdIter> reverse_copy(
...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        struct reverse final : public algorithm<reverse<Iter>, Iter>
        {
    ...
    namespace detail {
        ...
        constexpr util::in_out_result<BidirIt, OutIter>
        ...
        struct reverse_copy final
          : public algorithm<reverse_copy<IterPair>, IterPair>
        {
