...
namespace hpx {
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, void> replace(
    ...
    template <typename ExPolicy, typename FwdIter, typename Pred,
        typename T = typename std::iterator_traits<FwdIter>::value_type>
    hpx::util::detail::algorithm_result_t<ExPolicy, void> replace_if(
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, FwdIter2> replace_copy(
    ...
    template <typename ExPolicy, typename FwdIter1, typename FwdIter2,
        typename Pred,
        typename T = typename std::iterator_traits<FwdIter2>::value_type>
    hpx::util::detail::algorithm_result_t<ExPolicy, FwdIter2> replace_copy_if(
        ExPolicy&& policy, FwdIter1 first, FwdIter1 last, FwdIter2 dest,
        Pred&& pred, T const& new_value);
...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        template <typename Iter>
        struct replace_if final : public algorithm<replace_if<Iter>, Iter>
        {
    ...
    namespace detail {
        ...
        struct replace_copy final
          : public algorithm<replace_copy<IterPair>, IterPair>
        {
