...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        Iter sequential_destroy(Iter first, Sent last) noexcept
        {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <typename FwdIter>
        struct destroy final : public algorithm<destroy<FwdIter>, FwdIter>
        {
            ...
            static Iter sequential(ExPolicy, Iter first, Sent last) noexcept
            {
    ...
    namespace detail {
        ...
        Iter sequential_destroy_n(Iter first, std::size_t count) noexcept
        {
        ...
        template <typename FwdIter>
        struct destroy_n final : public algorithm<destroy_n<FwdIter>, FwdIter>
        {
            ...
            static Iter sequential(
                ExPolicy, Iter first, std::size_t count) noexcept
            {
