...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        struct min_element final : public algorithm<min_element<Iter>, Iter>
        {
    ...
    namespace detail {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <typename Iter>
        struct max_element final : public algorithm<max_element<Iter>, Iter>
        {
            // this has to be a member of the algorithm type as we access this
            // generically from the segmented algorithms
            template <typename ExPolicy, typename FwdIter, typename F,
