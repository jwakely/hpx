...
namespace hpx {
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, FwdIter2>
...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        // sequential copy_n
        template <typename IterPair>
        struct copy_n final : public algorithm<copy_n<IterPair>, IterPair>
        {
    ...
    namespace detail {
        ...
        template <typename IterPair>
        struct copy_if final : public algorithm<copy_if<IterPair>, IterPair>
        {
