...
namespace hpx {
    ...
    hpx::util::detail::algorithm_result_t<ExPolicy, bool> is_partitioned(
...
namespace hpx::parallel {
    ...
    namespace detail {
        ...
        /// \cond NOINTERNAL
        bool sequential_is_partitioned(std::vector<hpx::future<bool>>&& res)
        {
